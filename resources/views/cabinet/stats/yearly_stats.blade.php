...
<div class="container-fluid mb-4">
  <div class="row">
    <div class="col-12 d-flex justify-content-center align-items-center gap-3">
      <a href="{{ route('yearlyStats', ['year' => $year - 1]) }}" class="btn btn-outline-secondary btn-sm">&larr;</a>
      <h4 class="mb-0">{{ $year }}</h4>
      @if ($year < now()->year)
        <a href="{{ route('yearlyStats', ['year' => $year + 1]) }}" class="btn btn-outline-secondary btn-sm">&rarr;</a>
      @else
